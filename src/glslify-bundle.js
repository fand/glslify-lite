...
var clean = require("./clean-suffixes");
...
const entryExample = {
  id: 0,
  deps: { "./complex-ray": 1, "./complex-ray-result": 2, "./complex-march": 3 },
  file:
    "/Users/amagi/src/github.com/glslify/glslify-bundle/fixtures/complex.glsl",
  source:
...
/**
 * @param {Entry[]} entry - An array of dependency entry returned from deps
 * @return {Token[]} tokens
 */
